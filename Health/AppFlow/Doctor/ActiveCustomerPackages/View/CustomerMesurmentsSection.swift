//
//  CustomerMesurmentsSection.swift
//  Sehaty
//
...
struct CustomerMesurmentsSection: View {
...
//        GridItem(.flexible()),
    ...
    var body: some View {
        VStack{
            SectionHeader(image: Image(.newlastmesicon),title: "Customer_Mesurements"){
...
#Preview {
    CustomerMesurmentsSection(action: {_ in })
}
